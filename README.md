<p align="center">
  <a href="https://yincheng429.cn">
    <img src="./assets/profile-hero.svg" alt="Cheng Yin — VLA systems that remember, reason, and act across time" />
  </a>
</p>
...
I am a Ph.D. researcher at HUST, undertaking joint research training with Tsinghua THUNLP and Beijing Zhongguancun Academy. My work focuses on embodied AI, vision-language-action models, robot learning, long-context memory, and the research systems that make these models easier to train and evaluate.

## Current Research

> **SimpleMemVLA** · `ONGOING RESEARCH`
>
> SimpleMemVLA studies whether a VLA can use timestamped long-horizon video context as memory, without adding a dedicated retrieval, compression, or recurrent-memory module.
...
<sub>Public GitHub data · refreshed 2026-08-31 05:46 UTC</sub>
<!-- PROFILE:END -->
